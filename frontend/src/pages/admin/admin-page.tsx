          ...
          <div className="flex flex-col md:flex-row justify-between mb-6 gap-4">
            <div className="flex border-b overflow-x-auto">
              {["dia", "mes", "año"].map((tab) => (
                <button
                  key={tab}
                  className={`py-2 px-4 font-medium whitespace-nowrap ${activeTab === tab ? "text-blue-600 border-b-2 border-blue-600" : "text-gray-500"}`}
                  onClick={() => setActiveTab(tab as "dia" | "mes" | "año")}
                >
          ...
          {!loading && chartData && (
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                ...
                <p className="text-2xl font-bold">
                  {selectedCapacitacion === "all" ? listaCapacitaciones.length : 1}
                </p>
              </div>
